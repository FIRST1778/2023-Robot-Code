...
//        return invalidNumber || (angleProfile!!.isFinished(angleTimer.get()) && extensionProfile!!.isFinished(extensionTimer.get()) && manipulatorProfile!!.isFinished(manipulatorTimer.get()))
//    }
//
