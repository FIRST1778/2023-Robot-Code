package org.frc1778.lib.pathplanner.auto;
...
import org.frc1778.lib.pathplanner.commands.FollowPathWithEvents;
...
public abstract class BaseAutoBuilder {
  ...
  protected CommandBase getStopEventCommands(PathPlannerTrajectory.StopEvent stopEvent) {
    List<CommandBase> commands = new ArrayList<>();
